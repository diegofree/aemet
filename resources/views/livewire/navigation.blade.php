        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <a href="/" class="flex-shrink-0 flex items-center">
                    ...
                    <img class="hidden lg:block h-8 w-auto" src="http://www.aemet.es/imagenes/gif/logo_AEMET_og.gif" alt="Workflow">
                </a>
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{route('stations.index')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Estaciones</a>
